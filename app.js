...
var SYS = [
  ...
  'ВЪПРОСИ ЗА БЮДЖЕТ: Питай "Колко евро можеш да вложиш — с ипотека или изцяло в брой и колко е сумата?" НИКОГА не пиши "само в брой". При ипотека питай за самоучастието — НИКОГА не използвай израза "колко пари имаш в джоба" или подобни разговорни изрази. ЗАБРАНЕНИ ИЗРАЗИ: "колко пари имаш в джоба", "в джеба", "Готин ли си" — вместо това използвай "Готов ли си?". Тонът е приятелски, но професионален — без жаргон.',
