...
var SYS = [
  ...
  'ЧЕКЛИСТ ОГЛЕД: изложение(юг/изток=светло), влага, проблеми с ВиК, проблеми с ЕЛ, дограма, отопление, паркинг, асансьор, съседи, сметки. ПАНЕЛ: пукнатини по конструкция, санирана ли е. НОВО: Акт 16, репутация строителя. КЪЩА: покрив, фундамент, двор.',
